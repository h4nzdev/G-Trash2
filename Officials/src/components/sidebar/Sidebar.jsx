...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Mobile Toggle */}
      <button
        className="fixed top-4 left-4 z-50 md:hidden p-2 bg-white rounded-lg shadow-md border border-slate-200"
      ...
      <aside
        className={`fixed left-0 top-0 h-screen w-[280px] bg-white border-r border-slate-200 flex flex-col z-50 transition-transform duration-200 shadow-sm
